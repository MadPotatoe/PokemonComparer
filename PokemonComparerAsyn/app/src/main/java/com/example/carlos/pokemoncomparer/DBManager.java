...
public class DBManager extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        mockData(db);
        GetPokemons getPokemons = new GetPokemons();
        getPokemons.execute();
    }
    ...
    private void mockData(SQLiteDatabase sqLiteDatabase) {
        ...
        mockPokemon(sqLiteDatabase, new Pokemon("Vikavolt",R.drawable.toucannon,new Type("Bug"),new Type("Electric"),184,134,156,216,139,104));
    ...
    public class GetPokemons extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... params) {
            ...
            mainActivity.asignPOkemon(pokemons);
            return null;
        }
    }
